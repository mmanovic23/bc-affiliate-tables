				...
				<div class="item">
					...
					<div class="col-logo">
						<div class="logo-link-wrapper">
							...
							<a class="logo-link" href="<?php the_sub_field('cta_affiliate_link'); ?>" target="_blank">					
					...
					<!-- bonus -->
					<div class="col-bonus">
						<a href="<?php the_sub_field('cta_affiliate_link'); ?>" onclick="" target="_blank" class="bonus-link">
						...
						<div class="bonus-extra">
							...
							<div class="tooltipster-popover_templates">
		                        <span id="tooltipster-popover_content-<?php echo $i ?>">
		                            ...
		                            <p><?php the_sub_field('tc_popup_content'); ?></p>
					...
					<!-- ticks -->
					<div class="col-tick">
						<a href="<?php the_sub_field('cta_affiliate_link'); ?>" onclick="" target="_blank" class="tick-link">
					...
					<!-- button -->
					<div class="col-btn">
						<a href="<?php the_sub_field('cta_affiliate_link'); ?>" onclick="" target="_blank" role="button" class="btn btn-success">
